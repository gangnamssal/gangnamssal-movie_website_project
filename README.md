...
=======
![제목 없는 다이어그램.drawio](./기획서/제목 없는 다이어그램.drawio.png)
>>>>>>> b65f89b507ef8b21b7e3218d3892079e70193353
...
=======
![메인 페이지1](./PPT 캡쳐 사진/메인 페이지1.png)

#### 	메인 페이지 (아랫부분)

![메인 페이지2](./PPT 캡쳐 사진/메인 페이지2.png)

#### 8-2. 영화 디테일 페이지 (윗 부분)

![영화 디테일 페이지](./PPT 캡쳐 사진/영화 디테일 페이지.png)
>>>>>>> b65f89b507ef8b21b7e3218d3892079e70193353
...
=======
![영화 디테일 페이지2](./PPT 캡쳐 사진/영화 디테일 페이지2.png)

#### 8-3. 영화 리뷰 상세보기

![영화 리뷰 상세보기](./PPT 캡쳐 사진/영화 리뷰 상세보기.png)

#### 8-4. 영화 카테고리

![영화 카테고리 페이지(장르)](./PPT 캡쳐 사진/영화 카테고리 페이지(장르).png)

#### 8-5.  프로필 설정으로 MBTI와 취향 파악

![인증 관련 페이지(프로필 생성)](./PPT 캡쳐 사진/인증 관련 페이지(프로필 생성).png)

	#### MBTI 작성

![인증 관련 페이지(프로필 생성-MBTI 선택)](./PPT 캡쳐 사진/인증 관련 페이지(프로필 생성-MBTI 선택).png)

#### 선호 장르 작성

![인증 관련 페이지(프로필 생성-선호하는 장르 선택)](./PPT 캡쳐 사진/인증 관련 페이지(프로필 생성-선호하는 장르 선택).png)

#### 8-6. 내 프로필 보기

![인증 관련 페이지(내 프로필)](./PPT 캡쳐 사진/인증 관련 페이지(내 프로필).png)

#### 8-7. 검색 기능

![네이게이션바(검색-검색중)](./PPT 캡쳐 사진/네이게이션바(검색-검색중).png)

#### 8-8. MBTI를 기반으로 영화 추천

![추천 카테고리 페이지(MBTI)](./PPT 캡쳐 사진/추천 카테고리 페이지(MBTI).png)

#### 8-9. 사용자가 많이 좋아한 영화 순 추천

![추천 카테고리 페이지(뜨거워)](./PPT 캡쳐 사진/추천 카테고리 페이지(뜨거워).png)

#### 8-10. 사용자 취향에 따라 추천

![추천 카테고리 페이지(취향)](./PPT 캡쳐 사진/추천 카테고리 페이지(취향).png)
>>>>>>> b65f89b507ef8b21b7e3218d3892079e70193353
