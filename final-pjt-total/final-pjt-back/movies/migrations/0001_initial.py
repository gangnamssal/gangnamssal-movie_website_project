# Generated by Django 3.2.13 on 2022-11-22 16:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movies', models.ManyToManyField(blank=True, null=True, to='movies.Movie')),
                ('user', models.ManyToManyField(blank=True, null=True, related_name='user_genre', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
