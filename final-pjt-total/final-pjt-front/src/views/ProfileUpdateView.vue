    ...
    <div class="form-signin w-100 m-auto">
      ...
      <span>
        ...
        <label for="mbti" class="m-3">MBTI(선택 사항) : </label>
          <input class="form-control me-2" type="search" :placeholder="$store.state.userProfile.mbti" aria-label="Search" data-bs-toggle="modal" data-bs-target="#MBTIModal" style="width:200px;" v-model="MBTI" id="mbti">
        </form>
            <!-- Modal -->
      ...
      <span>
        <form class="d-flex justify-content-center" role="search">
          <input class="form-control me-2" type="search" :placeholder="$store.state.userPreferGenre" aria-label="Search" data-bs-toggle="modal" data-bs-target="#genreModal" style="width:1000px;" v-model="genre" id="genre">
        </form>
        <!-- 장르 선택 Modal -->
