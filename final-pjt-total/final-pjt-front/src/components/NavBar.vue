  ...
  <div>
    <nav class="navbar navbar-expand-lg navbar-dark bg-black fixed-top">
      <div class="container-fluid">
        <!-- 홈으로 -->
        <router-link :to="{ name: 'movie' }" class="navbar-brand"
          >극장</router-link
        ><br />
        <!-- 햄버거 -->
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <!-- 영화버튼 -->
            <li class="nav-item">
              <router-link :to="{ name: 'MovieLinkPageView' }" class="nav-link"
                >영화</router-link
              >
            </li>
            ...
            <li class="nav-item" v-if="!token">
              <router-link :to="{ name: 'AuthLinkPageView' }" class="nav-link"
                >안녕하시오 나그네!</router-link
              >
            </li>
            ...
            <li class="nav-item" v-else-if="token">
              <router-link :to="{ name: 'AuthLinkPageView' }" class="nav-link"
                >안녕하시오 {{ userInfo?.username }}!</router-link
              >
            </li>
          </ul>
